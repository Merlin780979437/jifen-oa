...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "style/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "style/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				case "theme-1":
					$(".navbar-brand img").attr("src", "style/assets/img/logo.png");
					break;
				case "theme-3":
					$(".navbar-brand img").attr("src", "style/assets/img/logo.png");
					break;
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "style/assets/css/themes/theme-2.css");
			$(".navbar-brand img").attr("src", "style/assets/img/logo.png");
