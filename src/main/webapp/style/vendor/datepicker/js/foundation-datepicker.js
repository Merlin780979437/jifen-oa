...
! function($) {
    ...
    var Datepicker = function(element, options) {
        ...
        $(document).on('mousedown', function(e) {
            ...
            var $len = $(e.target).closest('.datepicker.datepicker-inline, .datepicker.datepicker-dropdown').length;
            if ($len === 0) {
                that.hide();
                /**
                * 2016-08-24 zgs 修复输入框多次点击后不能显示时间选择窗口
                */
                that.element.blur();
            }
        });
    ...
    Datepicker.prototype = {
        ...
        place: function() {
            ...
            zIndex = 100000;
            //zIndex: zIndex lyc 2017年2月17日09:41:28去掉
            this.picker.css({
                top: fullOffsetTop,
                left: offsetLeft,
                zIndex : zIndex
