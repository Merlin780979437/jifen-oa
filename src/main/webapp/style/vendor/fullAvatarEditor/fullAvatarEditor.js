function fullAvatarEditor() {
	...
	var file			= 'style/vendor/fullAvatarEditor/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'style/vendor/fullAvatarEditor/expressInstall.swf';			//expressInstall.swf的路径
